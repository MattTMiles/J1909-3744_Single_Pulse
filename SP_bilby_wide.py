...
outdir = 'outdir_wide_window_check'
...
#priors['f'] = 1
priors['mu1'] = bilby.core.prior.Uniform(0, 2.5, 'mu1')
...
priors['alpha1'] = 2
priors['mu2'] = bilby.core.prior.Uniform(2.5, 7.5, 'mu2')
priors['sigma2'] = bilby.core.prior.Uniform(0.5, 10, 'sigma2')
#priors['A2'] = bilby.core.prior.Uniform(0, 10000, 'A2')
priors['alpha2'] = bilby.core.prior.Uniform(1.5, 10, 'alpha2')
#priors['alpha2'] = 2
