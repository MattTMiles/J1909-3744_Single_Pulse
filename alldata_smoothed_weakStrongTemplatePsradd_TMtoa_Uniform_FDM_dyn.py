...
#psradd versions
weak_template = np.load('/fred/oz002/users/mmiles/SinglePulse/Jitter_check/bilby_runs/J1909-3744_psradd_weak.npy')
...
results = bilby.core.sampler.run_sampler(
    ...
    outdir='two-mode-timing-psradd-Uniform_{}'.format(i))
