...
#Smoothed versions
weak_template = np.load('/fred/oz002/users/mmiles/SinglePulse/weak_prof_smoothed_1024.npy')
strong_template = np.load('/fred/oz002/users/mmiles/SinglePulse/strong_prof_smoothed_1024.npy')
...
results = bilby.core.sampler.run_sampler(
    ...
    outdir='two-mode-timing-smoothed-Gauss_{}'.format(i))
'''
